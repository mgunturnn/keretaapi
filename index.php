...
if (isset($_POST['cari'])) {
    $cari = $_POST['keyword'];
    $QueryString = "SELECT jadwal.id, jadwal.asal_rute, jadwal.tujuan_rute, jadwal.kelas, jadwal.harga, jadwal.tanggal, jadwal.waktu FROM jadwal WHERE
    	jadwal.id LIKE '%$cari%' or jadwal.asal_rute LIKE '%$cari%' or jadwal.tujuan_rute LIKE '%$cari%' or jadwal.kelas LIKE '%$cari%' or jadwal.harga LIKE '%$cari%' or jadwal.tanggal LIKE '%$cari%' or jadwal.waktu LIKE '%$cari%'";
...
<div class="wrapper">
    <div class="jumbotron text-center bg-warning header">
        <div class="text-white">
            <h4>Sistem Penjualan Tiket Kereta Api</h4>
        </div>
    </div>
    <div class="container">
