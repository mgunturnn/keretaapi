...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2023 at 10:38 AM
...
CREATE TABLE `gerbong` (
  `id` int(25) NOT NULL,
  `jml_kursi` int(25) NOT NULL,
  `kelas` varchar(25) NOT NULL,
  `id_kereta` int(25) NOT NULL
...
INSERT INTO `order` (`id`, `nama`, `no_hp`, `kategori_penumpang`, `tgl_order`, `jml_penumpang`, `id_user`, `id_jadwal`) VALUES
(1, 'Guntur', '+6289667811256', 'dewasa', '2023-06-05', 1, 6, 1);
...
(6, 'guntur', 'guntur@upi.edu', '30d8692c0d2ac50d082f20cfc4648206', 0),
(8, 'Aldi', 'aldi@upi.edu', 'c4fdebe929cdf83a1b4ddce0942b935d', 0);
